                            ...
                            <table class="table2A">
                                ...
                                <?php foreach ($data['poli'] as $poli) : ?>
                                    ...
                                    <tr?>
                                        ...
                                        <td class="tabel4A"><button class="btn1"><a href="<?= BASEURL?>/adminpoli/detail/<?=$poli['id_poli']?>">
                                        Detail</a></button>
                                        <button class = "btn2"><a href="<?= BASEURL?>/adminpoli/update/<?=$poli['id_poli']?>">Ubah</a></button>
                                        <button class = "btn3"><a href="<?= BASEURL?>/adminpoli/delete/<?=$poli['id_poli']?>" onclick="return confirm('Yakin?');">Hapus</a></button></td>
                                    </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= BASEURL; ?>/adminpoli/input" method="post">
